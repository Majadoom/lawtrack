...
<head>
 ...
 <!--meta name="viewport" content="width=640"--> <!--For Phone mobile content="width=640"-->

  
  <!-- Font Awesome -->
  <link rel="stylesheet" href="assets/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="icon" type="image/png" href="http://127.0.0.1/lawtrack.pwo.co.th/assets/dist/img/pwo8.png">
